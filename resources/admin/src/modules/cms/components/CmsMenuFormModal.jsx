...
const LINK_TYPE_OPTIONS = [
    ...
    { label: 'Danh sách chuyên đề tin tức', value: 'post-topic-index' },
    { label: 'Danh sách danh mục tin tức', value: 'post-category-index' },
    ...
    { label: 'Chuyên đề tin tức', value: 'post-topic' },
...
const SPECIAL_LINK_URLS = {
    ...
    'post-topic-index': STOREFRONT_ROUTES.newsTopics,
    'post-category-index': STOREFRONT_ROUTES.newsCategories,
...
function buildLinkLookups(linkOptions = {}) {
    return {
        ...
        'post-topic': new Map((linkOptions.postTopics ?? []).map((item) => [String(item.value), item])),
...
export default function CmsMenuFormModal({
    ...
    const itemLinkOptionSources = {
        ...
        'post-topic': linkOptions.postTopics ?? [],
