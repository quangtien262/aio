...
<footer id="footer" class="n503-footer">
    <div class="n503-container n503-footer-grid">
        <section>@include('themes.common.footer-logo')<p><i class="fa-regular fa-envelope"></i> {{ $email }}</p><p><i class="fa-solid fa-location-dot"></i> {{ $address }}</p><p><i class="fa-solid fa-phone"></i> {{ $phone }}</p></section>
