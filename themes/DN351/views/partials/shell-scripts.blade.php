...
(() => {
    ...
    document.documentElement.classList.add('dn351-motion');

    const reveal = [...document.querySelectorAll('[data-dn351-reveal]')];
    ...
    const menuButton = document.querySelector('[data-dn351-menu]');
    const nav = document.querySelector('[data-dn351-nav]');
    ...
    document.querySelectorAll('[data-dn351-slider]').forEach((slider) => {
        const slides = [...slider.querySelectorAll('[data-dn351-slide]')];
        const dots = [...slider.querySelectorAll('[data-dn351-dot]')];
