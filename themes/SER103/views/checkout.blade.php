...
@section('content')
    <section class="ser103-page-head">
        <div class="ser103-container">
            <nav class="ser103-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Thanh toán</span></nav>
    ...
    <section class="ser103-subpage">
        <div class="ser103-container">
            <form class="ser103-form" method="POST" action="{{ route('site.checkout.store') }}">
                @csrf
