...
@section('content')
    <section class="ser103-page-head">
        <div class="ser103-container">
            <nav class="ser103-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Tin tức</span></nav>
            <h1>{{ $title }}</h1>
    ...
    <section class="ser103-subpage">
        <div class="ser103-container ser103-detail">
            ...
            <article class="ser103-detail-body">{!! filled($body) ? $body : '<p>Nội dung đang được cập nhật.</p>' !!}</article>
        </div>
    </section>
@endsection
