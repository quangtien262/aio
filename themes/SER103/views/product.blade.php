...
@section('content')
    <section class="ser103-page-head">
        <div class="ser103-container">
            <nav class="ser103-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Sản phẩm</span></nav>
            <h1>{{ $title }}</h1>
    ...
    <section class="ser103-subpage">
        <div class="ser103-container ser103-detail">
            ...
            <div class="ser103-detail-body">
                @if(filled($price))<p class="ser103-price">{{ number_format((float) $price, 0, ',', '.') }}đ</p>@endif
