...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'NovaTech Mall'))</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" referrerpolicy="no-referrer">
    @include('theme-ec913::partials.styles')
    @stack('head')
</head>
<body>
@php
...
@endphp
<div class="ec13-page">
    @include('theme-ec913::partials.header')
    @yield('content')
    @include('theme-ec913::partials.footer')
</div>
...
@include('theme-ec913::partials.scripts')
@if($canEditLanding)
