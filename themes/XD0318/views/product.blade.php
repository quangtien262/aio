@php
    ...
    $primaryImage = $gallery[0]['url'] ?? ($product['image'] ?? 'https://picsum.photos/seed/XD0318-product/1200/900');
    ...
    $footerNewsletterSource = 'theme-footer-XD0318-product';
@endphp
                    ...
                    <section class="xd-related">
                        @foreach (collect($relatedProducts)->take(4) as $related)
                            <article class="xd-related-card">
                                <a href="{{ $related['url'] ?? '#' }}">
                                    <img src="{{ $related['image'] ?? 'https://picsum.photos/seed/XD0318-related/640/420' }}" alt="{{ $related['title'] ?? 'SÃ¡ÂºÂ£n phÃ¡ÂºÂ©m' }}">
                                    <div>
