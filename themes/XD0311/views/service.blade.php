                    ...
                    <section class="xd-detail">
                        <article class="xd-detail-card">
                            ...
                            <div class="xd-detail-body">
                                <span class="xd-kicker">{{ app()->getLocale() === 'en' ? 'Service' : 'DÃ¡Â»â€¹ch vÃ¡Â»Â¥' }}</span>
                                <h1>{{ $entry->title }}</h1>
                                @if (!empty($entry->excerpt))
                                    <p class="xd-detail-summary">{{ $entry->excerpt }}</p>
                                @endif
                                <div class="xd-rich-content">
                                    {!! $entry->body ?: '<p>NÃ¡Â»â„¢i dung Ã„â€˜ang Ã„â€˜Ã†Â°Ã¡Â»Â£c cÃ¡ÂºÂ­p nhÃ¡ÂºÂ­t.</p>' !!}
                                </div>
                        ...
                        <aside class="xd-side-card">
                            <h3>{{ app()->getLocale() === 'en' ? 'Quick links' : 'LiÃƒÂªn kÃ¡ÂºÂ¿t nhanh' }}</h3>
                            <a href="{{ route('site.services.index') }}">{{ app()->getLocale() === 'en' ? 'All services' : 'TÃƒÂ¡Ã‚ÂºÃ‚Â¥t cÃƒÂ¡Ã‚ÂºÃ‚Â£ dÃƒÂ¡Ã‚Â»Ã¢â‚¬Â¹ch vÃƒÂ¡Ã‚Â»Ã‚Â¥' }}</a>
