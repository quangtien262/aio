@php
    ...
    $companyName = trim((string) ($branding['company_name'] ?? data_get($siteProfile ?? [], 'site_name', 'InVess'))) ?: 'InVess';
    $companyDescription = trim((string) ($branding['company_description'] ?? 'Dịch vụ kế toán, thuế và tư vấn tài chính minh bạch cho doanh nghiệp.'));
