...
>
    ...
    @include('theme-tool750::partials.styles')
    @if($canEditLanding ?? false)
        @include('theme-foot403::partials.inline-editor-styles')
    @endif
</x-storefront-head>
<body>
    <div id="top" class="tool750-page">
        @include('theme-tool750::partials.header')
        @yield('content')
        @include('theme-tool750::partials.footer')
    </div>
    @include('theme-xd0323::partials.auth-modal')
    @if($canEditLanding ?? false)
        @include('theme-xd0302::partials.inline-editor')
    @endif
    @include('theme-tool750::partials.scripts')
    @stack('scripts')
</body>
</html>
