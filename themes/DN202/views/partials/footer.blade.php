...
<footer id="lien-he" class="d202-footer">
    <div class="d202-container d202-footer-grid">
        <section>@include('themes.common.footer-logo')<h3>{{ $t('footer.help') }}</h3><h4>{{ $t('footer.free_consulting') }}</h4><a class="d202-hotline" href="tel:{{ preg_replace('/[^0-9+]/', '', $hotline) }}">{{ $hotline }}</a><p>{{ $address }}<br><a href="mailto:{{ $email }}">{{ $email }}</a></p><div class="d202-social"><a href="#" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a><a href="#" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a><a href="#" aria-label="Youtube"><i class="fa-brands fa-youtube"></i></a></div></section>
