...
<header class="ec93-header">
    ...
    <nav class="ec93-nav"><div class="ec93-container"><button type="button" data-ec93-menu><i class="fa-solid fa-bars"></i> DANH MỤC <i class="fa-solid fa-chevron-down"></i></button><a href="{{ route('site.home') }}#deal-noi-bat">DEAL MỚI</a><a href="{{ route('site.home') }}#am-thuc">DEAL BÁN CHẠY</a></div></nav>
</header>
