...
<footer class="ec93-footer">
    <div class="ec93-container ec93-footer-grid">
        ...
        <section><h3>CÔNG TY CỔ PHẦN DEALVUI</h3><h4>VĂN PHÒNG HCM</h4><p>{{ data_get($branding, 'support_location', '70 Lữ Gia, Phường 15, Quận 11, TP.HCM') }}<br>Điện thoại: {{ data_get($branding, 'support_hotline', '1900 6760') }}</p><h4>CHĂM SÓC KHÁCH HÀNG</h4><p>Hotline: {{ data_get($branding, 'support_hotline', '1900 6760') }}<br>Email: {{ data_get($branding, 'support_email', 'cs@dealvui.vn') }}</p></section>
    </div>
</footer>
