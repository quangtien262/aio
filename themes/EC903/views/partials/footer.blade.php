...
<footer class="ec93-footer">
    <div class="ec93-container ec93-footer-grid">
        <section>@include('themes.common.footer-logo')<h3>TRỢ GIÚP</h3><a href="#">Chính sách giao hàng</a><a href="#">DealVui E-voucher</a><a href="#">Cách thức thanh toán</a><a href="#">Chính sách đổi trả hàng</a><a href="#">Điều khoản sử dụng</a></section>
