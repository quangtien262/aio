...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Bean Lingerie'))</title>
    ...
    @include('theme-shop604::partials.styles')
    @stack('head')
</head>
<body>
<div class="s604-page">
    @include('theme-shop604::partials.header')
    @yield('content')
    @include('theme-shop604::partials.footer')
</div>
...
@include('theme-shop604::partials.shell-scripts')
