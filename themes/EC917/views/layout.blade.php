...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'EGA Furniture'))</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" referrerpolicy="no-referrer">
    @include('theme-ec917::partials.styles')
    @stack('head')
...
@endphp
<div class="ec17-page">
    @include('theme-ec917::partials.header')
    @yield('content')
    @include('theme-ec917::partials.footer')
</div>
...
@include('theme-ec917::partials.scripts')
@if($canEditLanding)
