...
<footer class="ec92-footer"><div class="ec92-container ec92-footer-grid">
    <section>@include('themes.common.footer-logo')<p>Hệ thống bán lẻ smartphone, máy tính bảng, laptop và thiết bị công nghệ chính hãng với giá tốt, trả góp linh hoạt, giao hàng nhanh.</p><p><b>Địa chỉ:</b> {{ $location }}</p><p><b>Điện thoại:</b> {{ $hotline }}</p><p><b>Email:</b> {{ $email }}</p></section>
