@php
    ...
    $nt504EditorBlocks = collect($landingBlocks ?? [])
...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Wolf Paint'))</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" referrerpolicy="no-referrer">
    @include('theme-nt504::partials.styles')
    @stack('head')
    @include('partials.localized-seo')
</head>
<body>
    <div class="n504-page">
        @include('theme-nt504::partials.header')
        @yield('content')
        @include('theme-nt504::partials.footer')
    </div>

    @include('theme-xd0323::partials.auth-modal')
    @include('theme-nt504::partials.scripts')

    @if($canEditLanding && $nt504EditorBlocks->isNotEmpty())
        @include('site.partials.landing-admin-editor', [
            'landingBlocks' => $nt504EditorBlocks,
            'blockPayload' => $nt504EditorBlocks->keyBy('id')->toArray(),
