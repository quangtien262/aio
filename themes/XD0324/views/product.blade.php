@php
    ...
    $primaryImage = $gallery[0]['url'] ?? ($product['image'] ?? 'https://picsum.photos/seed/XD0324-product/1200/900');
    ...
    $footerNewsletterSource = 'theme-footer-XD0324-product';
@endphp
                    ...
                    <section class="xd-related">
                        @foreach (collect($relatedProducts)->take(4) as $related)
                            <article class="xd-related-card">
                                <a href="{{ $related['url'] ?? '#' }}">
                                    <img src="{{ $related['image'] ?? 'https://picsum.photos/seed/XD0324-related/640/420' }}" alt="{{ $related['title'] ?? 'Sản phẩm' }}">
                                    <div>
