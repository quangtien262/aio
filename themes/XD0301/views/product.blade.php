        ...
        <main class="xd-page-main">
            <div class="xd-container">
                @if (session('cart_success'))
                    <div class="xd-panel" style="margin-bottom:24px">{{ session('cart_success') }}</div>
                @endif
                    ...
                    <article class="xd-info-panel">
                        ...
                        <form class="xd-purchase-form" method="POST" action="{{ route('site.cart.add', ['slug' => $productModel->slug]) }}">
                            ...
                            <div class="xd-cta-row">
                                ...
                                @else
                                    <a class="xd-btn xd-btn-outline" href="{{ route('customer.auth.login') }}">Đăng nhập để lưu</a>
                                @endif
                            </div>
            ...
            <div class="xd-container xd-footer-grid">
                ...
                <div>
                    ...
                    <form class="xd-newsletter" action="{{ route('site.newsletter.subscribe') }}" method="post">
                        @csrf
                        <input type="hidden" name="source" value="theme-footer-xd0301-product">
