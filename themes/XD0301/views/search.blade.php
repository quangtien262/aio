...
<head>
    ...
    <title>{{ $searchQuery !== '' ? 'Tìm kiếm: '.$searchQuery : 'Tìm kiếm sản phẩm' }} | {{ $logoAlt }}</title>
    <style>
...
<body>
    <div id="top" class="xd-page">
            ...
            <section class="xd-container xd-search-shell">
                <aside>
                    ...
                    <div class="xd-panel xd-promo">
                        ...
                        <p>Gửi từ khóa hoặc gọi hotline để đội ngũ XD0301 gợi ý nhóm sản phẩm phù hợp cho công trình.</p>
                    </div>
                </aside>
        ...
        <footer class="xd-footer" id="lien-he">
            <div class="xd-container xd-footer-grid">
                <div>
                    <a class="xd-logo" href="{{ route('site.home') }}">
                        @if ($logoUrl !== '')
                            <img class="xd-logo-image" src="{{ $logoUrl }}" alt="{{ $logoAlt }}">
                        @else
                            <i class="xd-logo-mark" aria-hidden="true"></i><b>Ar<span>kit</span></b>
                    ...
                    <p>{{ $logoAlt }} là đơn vị tư vấn, cung cấp và thi công giải pháp cho công trình hiện đại.</p>
                </div>
                <div>
                    <h3>Thông tin</h3>
                    <div class="xd-footer-links">
                        ...
                        <a href="{{ url('/'.app()->getLocale().'/gioi-thieu') }}">Giới thiệu</a>
                        <a href="{{ url('/'.app()->getLocale().'/lien-he') }}">Liên hệ</a>
                    </div>
                </div>
                <div>
                    <h3>Liên hệ</h3>
                ...
                <div>
                    ...
                    <p>Nhận thông tin sản phẩm và tư vấn vật tư mới nhất.</p>
