...
<div class="sf-language-mobile-slot">@include('partials.storefront-language-switcher')</div>
    <div class="f405-container f405-header__main">
        ...
        <form class="f405-search" action="{{ route('site.catalog.search') }}" method="get"><input type="search" name="q" value="{{ request('q') }}" placeholder="@themeT('FOOT405.search_placeholder', 'Nhập từ khóa tìm kiếm...')"><button type="submit" aria-label="Tìm kiếm"><i class="fa-solid fa-magnifying-glass"></i></button></form>
