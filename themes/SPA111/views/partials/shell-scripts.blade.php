<script>
    (() => {
        const menuToggle = document.querySelector('[data-spa111-menu-toggle]');
        const menu = document.querySelector('[data-spa111-menu]');
        menuToggle?.addEventListener('click', () => menu?.classList.toggle('is-open'));

        const slides = Array.from(document.querySelectorAll('[data-spa111-hero-slide]'));
        const dots = Array.from(document.querySelectorAll('[data-spa111-hero-dot]'));
        const prev = document.querySelector('[data-spa111-hero-prev]');
        const next = document.querySelector('[data-spa111-hero-next]');
        let active = 0;
        let timer = null;
