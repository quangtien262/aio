...
@section('content')
    <section class="spa111-page-head">
        <div class="spa111-container">
            <nav class="spa111-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Sản phẩm</span></nav>
            <h1>{{ $title }}</h1>
    ...
    <section class="spa111-subpage">
        <div class="spa111-container spa111-detail">
            ...
            <div class="spa111-detail-body">
                @if(filled($price))<p class="spa111-price">{{ number_format((float) $price, 0, ',', '.') }}đ</p>@endif
