@php
    ...
    $footerNewsletterSource = 'theme-footer-xd0304-search';
@endphp
            ...
            <section class="xd-container xd-search-shell">
                <aside>
                    ...
                    <div class="xd-panel xd-promo">
                        ...
                        <p>Gửi từ khóa hoặc gọi hotline để đội ngũ XD0304 gợi ý nhóm sản phẩm phù hợp cho công trình.</p>
                    </div>
                </aside>
                            ...
                            @foreach ($productItems as $product)
                                <a class="xd-product-card" href="{{ $product['url'] ?? '#' }}">
                                    <span class="xd-product-image">
                                        <img src="{{ $product['image'] ?? 'https://picsum.photos/seed/xd0304-product/720/540' }}" alt="{{ $product['title'] ?? '' }}">
