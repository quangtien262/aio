...
<section>@include('themes.common.footer-logo')<p>{{ data_get($branding, 'company_description', 'Nền tảng mua bán ô tô minh bạch, nhanh chóng và đáng tin cậy.') }}</p><div class="a851-social"><i class="fa-brands fa-facebook-f"></i><i class="fa-brands fa-youtube"></i><i class="fa-brands fa-instagram"></i></div></section>
