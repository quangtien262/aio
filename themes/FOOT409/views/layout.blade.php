...
>
    <link rel="preconnect" href="https://fonts.googleapis.com">
        ...
        @include('theme-foot409::partials.styles')
</x-storefront-head>
<body>
@php
...
@endphp
<div class="f409-page" id="top">
    @include('theme-foot409::partials.header')
    @yield('content')
    @include('theme-foot409::partials.footer')
</div>
...
@include('theme-foot409::partials.scripts')
