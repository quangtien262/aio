...
<footer class="ec95-footer"><div class="ec95-container ec95-footer-grid">
    ...
    <section><h3>Tổng đài hỗ trợ</h3><p class="ec95-hotline"><i class="fa-solid fa-phone"></i><b>{{ data_get($brand, 'support_hotline', '0399162342') }}</b><span>Tư vấn online 8:00 - 18:30</span></p><p class="ec95-hotline"><i class="fa-solid fa-phone"></i><b>{{ data_get($brand, 'support_hotline', '0399162342') }}</b><span>Phản ánh chất lượng dịch vụ</span></p></section>
