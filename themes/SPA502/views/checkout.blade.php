...
@section('content')
    <section class="spa502-page-head">
        <div class="spa502-container">
            <nav class="spa502-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Thanh toán</span></nav>
    ...
    <section class="spa502-subpage">
        <div class="spa502-container">
            <form class="spa502-form" method="POST" action="{{ route('site.checkout.store') }}">
                @csrf
