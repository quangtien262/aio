...
@section('content')
    <section class="spa502-page-head">
        <div class="spa502-container">
            <nav class="spa502-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Sản phẩm</span></nav>
            <h1>{{ $title }}</h1>
    ...
    <section class="spa502-subpage">
        <div class="spa502-container spa502-detail">
            ...
            <div class="spa502-detail-body">
                @if(filled($price))<p class="spa502-price">{{ number_format((float) $price, 0, ',', '.') }}đ</p>@endif
