                    ...
                    <section class="xd-detail">
                        <article class="xd-detail-card">
                            ...
                            <div class="xd-detail-body">
                                <span class="xd-kicker">{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('TH0050', app()->getLocale(), 'legacy_inline.c88c165a29889115', 'Dịch vụ') }}</span>
                                <h1>{{ $entry->title }}</h1>
                        ...
                        <aside class="xd-side-card">
                            <h3>{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('TH0050', app()->getLocale(), 'legacy_inline.f83250cd1d652333', 'Liên kết nhanh') }}</h3>
                            <a href="{{ route('site.services.index') }}">{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('TH0050', app()->getLocale(), 'legacy_inline.44cd126d3a55a78b', 'Tất cả dịch vụ') }}</a>
                            ...
                            @if (!empty($latestServices) && $latestServices->count() > 0)
                                <div class="xd-latest-services">
                                    <h4>{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('TH0050', app()->getLocale(), 'legacy_inline.0e16ca70307dacb8', 'Dịch vụ mới nhất') }}</h4>
