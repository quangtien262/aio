                    ...
                    <section class="xd-cms-hero">
                        <div>
                            ...
                            @if (!empty($entry->excerpt))
                                <p>{{ $entry->excerpt }}</p>
                            @else
                                <p>{{ app()->getLocale() === 'en' ? 'Send your request and our team will contact you shortly.' : 'Gửi nhu cầu tư vấn quà tặng hoặc chăm sóc sức khỏe. Đội ngũ An Nhiên sẽ sớm phản hồi.' }}</p>
                            @endif
                        </div>
