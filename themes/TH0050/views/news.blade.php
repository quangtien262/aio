            ...
            <div class="xd-container">
                    <section class="xd-cms-hero">
                        <div>
                            ...
                            <p>{{ $pageDescription ?? (app()->getLocale() === 'en' ? 'Latest company updates and wellness insights.' : 'Danh sách bài viết, tin tức và kinh nghiệm chăm sóc sức khỏe mới nhất.') }}</p>
                        </div>
