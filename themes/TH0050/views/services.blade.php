            ...
            <div class="xd-container">
                    <section class="xd-cms-hero">
                        <div>
                            ...
                            <p>{{ $pageDescription ?? (app()->getLocale() === 'en' ? 'Explore our wellness and premium gifting services.' : 'Khám phá dịch vụ chăm sóc sức khỏe và quà tặng cao cấp của chúng tôi.') }}</p>
                        </div>
