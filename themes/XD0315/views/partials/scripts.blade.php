    <script>
        (() => {
            const af15Nav = document.querySelector('[data-af15-nav]');
            document.querySelector('[data-af15-menu-toggle]')?.addEventListener('click', (event) => {
                const isOpen = af15Nav?.classList.toggle('is-open') || false;
            ...
            const restartaf15Hero = () => {
                window.clearInterval(af15HeroTimer);
                af15HeroTimer = window.setInterval(() => showaf15Hero(af15HeroIndex + 1), 6200);
            };
