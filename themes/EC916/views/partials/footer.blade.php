...
<footer class="ec16-footer">
    <div class="ec16-container ec16-footer-grid">
        <section>@include('themes.common.footer-logo')<h3>Hỗ trợ khách hàng</h3><a href="#">Các câu hỏi thường gặp</a><a href="{{ route('site.contact') }}">Gửi yêu cầu hỗ trợ</a><a href="#">Hướng dẫn đặt hàng</a><a href="#">Phương thức vận chuyển</a><a href="#">Chính sách đổi trả</a></section>
