...
<footer class="ec16-footer">
    <div class="ec16-container ec16-footer-grid">
        ...
        <section><h3>Liên hệ</h3><p><i class="fa-solid fa-phone"></i> {{ data_get($branding, 'support_hotline', '0399162342') }}</p><p><i class="fa-solid fa-envelope"></i> {{ data_get($branding, 'support_email', 'support@htvietnam.vn') }}</p><p><i class="fa-solid fa-location-dot"></i> {{ data_get($branding, 'support_location', 'Hà Nội, Việt Nam') }}</p></section>
    </div>
