            ...
            <section class="xd-container xd-search-shell">
                <aside>
                    ...
                    <div class="xd-panel xd-promo">
                        ...
                        <p>GÃƒÂ¡Ã‚Â»Ã‚Â­i tÃƒÂ¡Ã‚Â»Ã‚Â« khÃƒÆ’Ã‚Â³a hoÃƒÂ¡Ã‚ÂºÃ‚Â·c gÃƒÂ¡Ã‚Â»Ã‚Âi hotline Ãƒâ€žÃ¢â‚¬ËœÃƒÂ¡Ã‚Â»Ã†â€™ Ãƒâ€žÃ¢â‚¬ËœÃƒÂ¡Ã‚Â»Ã¢â€žÂ¢i ngÃƒâ€¦Ã‚Â© XD0323 gÃƒÂ¡Ã‚Â»Ã‚Â£i ÃƒÆ’Ã‚Â½ nhÃƒÆ’Ã‚Â³m sÃƒÂ¡Ã‚ÂºÃ‚Â£n phÃƒÂ¡Ã‚ÂºÃ‚Â©m phÃƒÆ’Ã‚Â¹ hÃƒÂ¡Ã‚Â»Ã‚Â£p cho cÃƒÆ’Ã‚Â´ng trÃƒÆ’Ã‚Â¬nh.</p>
                    </div>
                </aside>
                            ...
                            @foreach ($productItems as $product)
                                <a class="xd-product-card" href="{{ $product['url'] ?? '#' }}">
                                    <span class="xd-product-image">
                                        <img src="{{ $product['image'] ?? 'https://picsum.photos/seed/XD0323-product/720/540' }}" alt="{{ $product['title'] ?? '' }}">
