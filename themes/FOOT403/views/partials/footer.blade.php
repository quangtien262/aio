@php
    ...
    $phone = $branding['support_hotline'] ?? '0399162342'; $email = $branding['support_email'] ?? 'support@htvietnam.vn'; $address = $branding['support_location'] ?? '70 Lữ Gia, Phường 15, Quận 11, TP.HCM';
@endphp
