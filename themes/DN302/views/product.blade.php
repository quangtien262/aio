...
@push('head')
    ...
    <style>
        ...
        .dn-product-info{padding:15px}.dn-product-category{display:inline-flex;align-items:center;min-height:34px;margin-bottom:18px;padding:0 13px;background:var(--dn-champagne);color:var(--dn-navy);font-size:12px;font-weight:850;letter-spacing:.1em;text-transform:uppercase}
            ...
            <div class="dn-container">
                ...
                <div class="dn-product-top">
                    ...
                    <article class="dn-product-info">
                        <span class="dn-product-category">{{ data_get($category, 'name', 'Sản phẩm DN302') }}</span>
                        <h2>{{ $title }}</h2>
