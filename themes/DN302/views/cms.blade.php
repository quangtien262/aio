@php
    ...
    $companyName = trim((string) data_get($branding, 'company_name', data_get($siteProfile ?? [], 'site_name', 'DN302')));
...
@push('head')
    <style>
        ...
        .dn-page-hero{position:relative;overflow:hidden;padding:255px 0 94px;background:var(--dn-navy);color:#fff}
        ...
        .dn-page-breadcrumb{position:relative;z-index:2;display:flex;flex-wrap:wrap;align-items:center;gap:10px;margin-bottom:40px;color:rgba(255,255,255,.58);font-size:14px;font-weight:700}
        ...
        .dn-page-hero-media img{width:100%;height:100%;object-fit:cover}
        ...
        @media(max-width:1180px){.dn-page-hero-grid,.dn-page-layout{grid-template-columns:1fr}.dn-page-hero-media{height:540px}.dn-page-sidebar{position:static;grid-template-columns:1fr 1fr}.dn-page-latest-grid{grid-template-columns:1fr}.dn-page-latest-card{grid-template-columns:220px 1fr}}
        @media(max-width:760px){.dn-page-hero{padding:110px 0 70px}.dn-page-hero-grid{gap:38px}.dn-page-hero-media{height:350px}.dn-page-card{padding:30px 22px}.dn-page-intro{grid-template-columns:1fr}.dn-page-intro__mark{width:58px;height:58px}.dn-page-intro p{font-size:18px}.dn-page-content{font-size:16px}.dn-page-content h2{font-size:28px}.dn-page-sidebar{grid-template-columns:1fr}.dn-page-section-head h2{font-size:32px}.dn-page-latest-card{grid-template-columns:110px 1fr}.dn-page-latest-body{padding:17px}}
    </style>
@endpush
