                    ...
                    <section class="xd-detail">
                        <article class="xd-detail-card">
                            ...
                            <div class="xd-detail-body">
                                <span class="xd-kicker">{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('XD0312', app()->getLocale(), 'legacy_inline.377a3eee1f09a209', 'Dịch vụ') }}</span>
                                <h1>{{ $entry->title }}</h1>
                        ...
                        <aside class="xd-side-card">
                            <h3>{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('XD0312', app()->getLocale(), 'legacy_inline.454c355e6e188f9e', 'Liên kết nhanh') }}</h3>
                            <a href="{{ route('site.services.index') }}">{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('XD0312', app()->getLocale(), 'legacy_inline.99fe1026776f8dce', 'Tất cả dịch vụ') }}</a>
