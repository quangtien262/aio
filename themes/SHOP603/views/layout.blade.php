...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Alena'))</title>
    ...
    @include('theme-shop603::partials.styles')
    @stack('head')
    @include('partials.localized-seo')
</head>
<body>
<div class="s603-page">
    @include('theme-shop603::partials.header')
    @yield('content')
    @include('theme-shop603::partials.footer')
</div>
...
@include('theme-shop603::partials.shell-scripts')
