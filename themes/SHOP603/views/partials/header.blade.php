...
$phone=trim((string)($branding['support_hotline']??''))?:'0399162342';
...
<header class="s603-header">
    <div class="s603-top"><div class="s603-container s603-top-grid">
        <a class="s603-logo" href="{{ route('site.home') }}">@if($logo)<img src="{{ $logo }}" alt="{{ $name }}">@else<span>A</span><b>lena</b>@endif</a>
