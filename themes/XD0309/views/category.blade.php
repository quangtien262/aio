@php
    ...
    $footerNewsletterSource = 'theme-footer-xd0309-category';
@endphp
            ...
            <section class="xd-container xd-catalog">
                <aside class="xd-sidebar">
                    ...
                    <div class="xd-panel xd-promo">
                        ...
                        <p>GÃ¡Â»Â­i nhu cÃ¡ÂºÂ§u cÃƒÂ´ng trÃƒÂ¬nh Ã„â€˜Ã¡Â»Æ’ Ã„â€˜Ã¡Â»â„¢i ngÃ…Â© XD0309 gÃ¡Â»Â£i ÃƒÂ½ nhÃƒÂ³m sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m vÃƒÂ  phÃ†Â°Ã†Â¡ng ÃƒÂ¡n triÃ¡Â»Æ’n khai phÃƒÂ¹ hÃ¡Â»Â£p.</p>
                    </div>
                </aside>
                            ...
                            @foreach ($productItems as $product)
                                <a class="xd-product-card" href="{{ $product['url'] ?? '#' }}">
                                    <span class="xd-product-image">
                                        <img src="{{ $product['image'] ?? 'https://picsum.photos/seed/xd0309-product/720/540' }}" alt="{{ $product['title'] ?? '' }}">
