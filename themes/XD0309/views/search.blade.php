@php
    ...
    $footerNewsletterSource = 'theme-footer-xd0309-search';
@endphp
            ...
            <section class="xd-container xd-search-shell">
                <aside>
                    ...
                    <div class="xd-panel xd-promo">
                        ...
                        <p>GÃ¡Â»Â­i tÃ¡Â»Â« khÃƒÂ³a hoÃ¡ÂºÂ·c gÃ¡Â»Âi hotline Ã„â€˜Ã¡Â»Æ’ Ã„â€˜Ã¡Â»â„¢i ngÃ…Â© XD0309 gÃ¡Â»Â£i ÃƒÂ½ nhÃƒÂ³m sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m phÃƒÂ¹ hÃ¡Â»Â£p cho cÃƒÂ´ng trÃƒÂ¬nh.</p>
                    </div>
                </aside>
