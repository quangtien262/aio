...
<footer class="bds-footer">
    <div class="bds-container bds-footer-grid">
        ...
        <div><h3>@themeT('footer.contact', 'Liên hệ')</h3><strong>{{ data_get($branding, 'support_hotline', '') }}</strong><p>{{ data_get($branding, 'support_location', '') }}</p><p>{{ data_get($branding, 'support_email', '') }}</p></div>
