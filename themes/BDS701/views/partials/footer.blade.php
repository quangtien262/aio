...
<footer class="bds-footer">
    <div class="bds-container bds-footer-grid">
        ...
        <div><h3>@themeT('footer.contact', 'Liên hệ')</h3><strong>{{ data_get($branding, 'support_hotline', '0399162342') }}</strong><p>{{ data_get($branding, 'support_location', 'An Thượng, Hà Nội') }}</p><p>{{ data_get($branding, 'support_email', 'contact@example.com') }}</p></div>
