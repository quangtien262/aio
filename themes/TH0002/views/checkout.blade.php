...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Thanh toán | {{ data_get($branding, 'company_name', 'TH0002') }}</title>
            ...
            <section class="checkout-layout">
                <form method="POST" action="{{ route('site.checkout.store') }}" class="checkout-panel">
                    ...
                    <div style="margin-top: 20px; display: flex; gap: 12px; flex-wrap: wrap;">
                        ...
                        <a href="{{ route('site.cart.index') }}" style="display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 22px;border:1px solid #e4b47a;color:#a85618;font-weight:700;">@themeT('checkout.back_to_cart', 'Quay lại giỏ hàng')</a>
                    </div>
                </form>
