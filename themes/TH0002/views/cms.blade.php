    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .th-cms-button.secondary { background: #fff; color: var(--th-red); border: 1px solid #efc9a2; }
            .th-cms-hero-meta { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; }
            .th-cms-stat { padding: 18px; border: 1px solid var(--th-line); border-radius: 22px; background: linear-gradient(180deg, #fff 0%, #fff5ec 100%); }
            ...
            .th-contact-info-icon { display: grid; place-items: center; width: 54px; height: 54px; border-radius: 18px; background: #fff0e4; color: var(--th-red); font-size: 28px; }
                                    ...
                                    <section class="th-cms-panel">
                                        ...
                                        <div class="th-cms-highlight-grid">
                                            <div class="th-cms-highlight">
                                                ...
                                                <span>{{ $t('cms.about.highlight_sync_body', 'Nội dung giới thiệu, tin tức và dữ liệu thương hiệu được render trực tiếp trên giao diện TH0002.') }}</span>
                                            </div>
                                            <div class="th-cms-highlight">
