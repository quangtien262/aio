...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Giỏ hàng | {{ data_get($branding, 'company_name', 'TH0002') }}</title>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .ghost-button { background: #fff; border: 1px solid #e4b47a; color: var(--th-green-dark); margin-top: 10px; }
    ...
    <body>
        ...
        <main class="wrap">
                        ...
                        <div class="cart-table">
                            @foreach ($cartItems as $item)
                                <article class="cart-row">
                                    <a href="{{ $item['url'] ?? '#' }}">
                                        <img src="{{ $item['image'] ?: 'https://picsum.photos/seed/th0002-product-fallback/640/420' }}" alt="{{ $item['title'] }}">
                                    </a>
            ...
            @else
                <div class="empty-state">@themeT('cart.empty', 'Giỏ hàng hiện đang trống. Hãy quay lại danh mục hoặc trang sản phẩm để thêm mẫu may, đồng phục hoặc sản phẩm retail trước khi gửi đơn.')</div>
            @endif
        </main>
