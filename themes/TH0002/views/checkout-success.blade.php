...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Đặt hàng thành công | {{ data_get($branding, 'company_name', 'TH0002') }}</title>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .utility { background: #f6efe6; border-bottom: 1px solid var(--th-line); font-size: 13px; color: var(--th-muted); }
            ...
            .success-card h1 { margin: 0 0 12px; font-size: 32px; text-transform: uppercase; color: #a85618; }
            ...
            .cta-link.secondary { border: 1px solid #e4c3a0; background: #fff; color: #a85618; }
    ...
    <body>
        ...
        <main class="wrap">
            <section class="success-card">
                ...
                <p>@themeT('checkout_success.summary', 'Đơn hàng của bạn đã được ghi nhận. Bộ phận tư vấn sẽ liên hệ theo số điện thoại đã cung cấp để xác nhận chất liệu, size, thời gian giao và các yêu cầu hoàn thiện nếu có.')</p>
