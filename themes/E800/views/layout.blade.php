...
>
    ...
    @include('theme-e800::partials.styles')
</x-storefront-head>
<body>
<div id="top" class="e800-page">
    @include('theme-e800::partials.header')
    @yield('content')
    @include('theme-e800::partials.footer')
</div>
@include('theme-xd0323::partials.auth-modal')
<style>
    .xd-auth-modal * { box-sizing: border-box; font-family: "Be Vietnam Pro", "Segoe UI", Roboto, Arial, sans-serif; }
    .xd-auth-card { color: #171717; }
    .xd-auth-tab.is-active, .xd-auth-submit { background: var(--e800-red); box-shadow: 0 12px 26px rgba(240, 68, 68, .24); }
</style>
@include('theme-xd0323::partials.inline-editor', ['canEditLanding' => $canEditLanding ?? false, 'editorLocales' => $editorLocales ?? []])
@include('theme-e800::partials.scripts')
