...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Mộc Nhiên Craft'))</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" referrerpolicy="no-referrer">
    @include('theme-ec914::partials.styles')
    @stack('head')
</head>
<body>
@php
...
@endphp
<div class="ec14-page">
    @include('theme-ec914::partials.header')
    @yield('content')
    @include('theme-ec914::partials.footer')
</div>
...
@include('theme-ec914::partials.scripts')
@if($canEditLanding)
