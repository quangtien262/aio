        ...
        <header class="header">
            <div class="wrap header-main">
                ...
                <div class="searchbar" role="search">
                    <input type="text" value="Đơn hàng đã xác nhận" aria-label="Đặt hàng thành công" readonly>
            ...
            <section class="success-card">
                ...
                <div class="order-grid">
                    ...
                    <div class="order-line">
                        ...
                        <span class="order-value">{{ $confirmedOrder->sms_sent_at ? 'Da gui' : 'Chua gui' }}</span>
                    </div>
                </div>
                ...
                <div class="cta-row">
                    ...
                    <a href="tel:19006760" class="cta-link secondary">Gọi hotline hỗ trợ</a>
                </div>
            </section>
        </main>
    </body>
