...
$phone=$branding['support_hotline']??'1900 6750';$cartCount=(int)data_get($cartSummary??[],'count',0);
@endphp
...
<header class="ca50-header">
 <div class="ca50-header-inner">
  <a class="ca50-logo" href="{{ route('site.home') }}"><span><i class="fa-solid fa-fish-fins"></i></span><b>SUDES<br><strong>AQUARIUM</strong></b></a>
