...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Atelier'))</title>
...
<body><div id="top" class="s606-page">@include('theme-shop606::partials.header')@yield('content')@include('theme-shop606::partials.footer')</div>
@include('theme-xd0323::partials.auth-modal')
@if($canEditLanding ?? false)@include('theme-xd0302::partials.inline-editor')@endif
@include('theme-shop606::partials.scripts') @stack('scripts')</body></html>
