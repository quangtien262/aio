...
>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@600;700;800&family=Be+Vietnam+Pro:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
    @include('theme-tool751::partials.styles')
    @if($canEditLanding ?? false)@include('theme-foot403::partials.inline-editor-styles')@endif
</x-storefront-head>
<body>
    <div id="top" class="tool751-page">
        @include('theme-tool751::partials.header')
        @yield('content')
        @include('theme-tool751::partials.footer')
    </div>
    @include('theme-xd0323::partials.auth-modal')
    @if($canEditLanding ?? false)@include('theme-xd0302::partials.inline-editor')@endif
    @include('theme-tool751::partials.scripts')
    @stack('scripts')
</body>
</html>
