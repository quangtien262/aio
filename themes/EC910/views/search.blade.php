...
<main>
    ...
    <section class="ec10-content"><div class="ec10-container">
        ...
        <div class="ec10-product-grid">@forelse(collect($entries ?? $products ?? []) as $item)@include('theme-ec910::partials.product-card', ['item' => $item])@empty<p class="ec10-empty">Không tìm thấy sản phẩm phù hợp.</p>@endforelse</div>
    </div></section>
</main>
@endsection
