...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Bookle'))</title>
...
@php
    ...
    $editorLocales = collect(\App\Support\FrontendLocalization::supportedLocales())
        ...
        ->all();
@endphp
<div class="book20-page">
    @include('theme-book920::partials.header')
    @yield('content')
    @include('theme-book920::partials.footer')
</div>
...
@include('theme-book920::partials.shell-scripts')
@if($canEditLanding)
