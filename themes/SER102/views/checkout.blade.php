...
@section('content')
    <section class="ser102-page-head">
        <div class="ser102-container">
            <nav class="ser102-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Thanh toán</span></nav>
    ...
    <section class="ser102-subpage">
        <div class="ser102-container">
            <form class="ser102-form" method="POST" action="{{ route('site.checkout.store') }}">
                @csrf
