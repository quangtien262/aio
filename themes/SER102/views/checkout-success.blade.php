...
@section('content')
    <section class="ser102-page-head">
        <div class="ser102-container">
            <nav class="ser102-breadcrumb"><a href="{{ route('site.home') }}">Trang chủ</a><span>/</span><span>Thành công</span></nav>
    ...
    <section class="ser102-subpage">
        <div class="ser102-container">
            <div class="ser102-empty">Cảm ơn bạn đã đặt hàng. Vui lòng giữ điện thoại để chúng tôi hỗ trợ nhanh nhất.</div>
        </div>
    </section>
@endsection
