...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'SER102 Auto Detailing'))</title>
    <meta name="description" content="@yield('meta_description', data_get($siteProfile ?? [], 'description', 'Dịch vụ chăm sóc xe chuyên nghiệp'))">
