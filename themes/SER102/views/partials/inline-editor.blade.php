@if ($canEditLanding)
    <div class="xd-editor" data-xd-editor hidden>
        <form class="xd-editor-card" data-xd-editor-form>
            <div class="xd-editor-head">
                <h3>Sửa khối landing</h3>
                <button type="button" class="xd-editor-close" data-xd-editor-close>&times;</button>
            </div>
            ...
            <div class="xd-editor-grid">
                ...
                <label class="xd-editor-field"><span>Link CTA</span><input data-xd-field="cta_url" placeholder="/p/gioi-thieu hoặc https://..."></label>
                ...
                <section class="xd-editor-source" data-xd-contact-editor hidden>
                    <div>
                        ...
                        <p class="xd-editor-source-note">Các trường này chỉ dùng cho block liên hệ trên landing page.</p>
                    </div>
                    <div class="xd-editor-grid">
            ...
            <div class="xd-editor-actions">
                <button type="button" data-xd-editor-close>Hủy</button>
