                    ...
                    <section class="xd-detail">
                        <article class="xd-detail-card">
                            ...
                            <div class="xd-detail-body">
                                <span class="xd-kicker">{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('XD0314', app()->getLocale(), 'legacy_inline.e47b2e11a79d4119', 'Dịch vụ') }}</span>
                                <h1>{{ $entry->title }}</h1>
                        ...
                        <aside class="xd-side-card">
                            <h3>{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('XD0314', app()->getLocale(), 'legacy_inline.d026809a2e96bf27', 'Liên kết nhanh') }}</h3>
                            <a href="{{ route('site.services.index') }}">{{ app(\App\Core\Themes\ThemeTranslationService::class)->bladeText('XD0314', app()->getLocale(), 'legacy_inline.1732748917910f72', 'Tất cả dịch vụ') }}</a>
