...
<head>
    ...
    <title>@yield('title', data_get($siteProfile ?? [], 'site_name', 'Sudes Phone'))</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" referrerpolicy="no-referrer">
    @include('theme-ec912::partials.styles')
    @stack('head')
...
@endphp
<div class="ec12-page">
    @include('theme-ec912::partials.header')
    @yield('content')
    @include('theme-ec912::partials.footer')
</div>
...
@include('theme-ec912::partials.scripts')
@if($canEditLanding)
