@php
    ...
    $footerNewsletterSource = 'theme-footer-xd0308-search';
@endphp
            ...
            <section class="xd-container xd-search-shell">
                <aside>
                    ...
                    <div class="xd-panel xd-promo">
                        ...
                        <p>Gá»­i tá»« khÃ³a hoáº·c gá»i hotline Ä‘á»ƒ Ä‘á»™i ngÅ© XD0308 gá»£i Ã½ nhÃ³m sáº£n pháº©m phÃ¹ há»£p cho cÃ´ng trÃ¬nh.</p>
                    </div>
                </aside>
                            ...
                            @foreach ($productItems as $product)
                                <a class="xd-product-card" href="{{ $product['url'] ?? '#' }}">
                                    <span class="xd-product-image">
                                        <img src="{{ $product['image'] ?? 'https://picsum.photos/seed/xd0308-product/720/540' }}" alt="{{ $product['title'] ?? '' }}">
