...
<footer class="ec99-footer"><div class="ec99-shell ec99-footer-grid">
    ...
    <section><h3>Thông tin</h3><p><b>Địa chỉ:</b> {{ data_get($branding, 'support_location', '70 Lữ Gia, Phường 15, Quận 11, TP.HCM') }}</p><p><b>Điện thoại:</b> {{ data_get($branding, 'support_hotline', '0399162342') }}</p><p><b>Email:</b> {{ data_get($branding, 'support_email', 'support@htvietnam.vn') }}</p><div class="ec99-marketplaces"><i>S</i><i>L</i><i>T</i><i>S</i></div></section>
