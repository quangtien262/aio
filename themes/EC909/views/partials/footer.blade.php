...
<footer class="ec99-footer"><div class="ec99-shell ec99-footer-grid">
    <section><a class="ec99-footer-logo" href="{{ route('site.home') }}"><span>Ξ</span><strong>EURO SOUND</strong></a><p>Euro Sound là cửa hàng chuyên cung cấp các thiết bị âm thanh chính hãng như loa, tai nghe có dây, tai nghe không dây và headphone chất lượng cao.</p><nav><a href="#"><i class="fa-brands fa-facebook-f"></i></a><a href="#"><i class="fa-brands fa-x-twitter"></i></a><a href="#"><i class="fa-brands fa-youtube"></i></a><a href="#"><i class="fa-brands fa-instagram"></i></a></nav></section>
