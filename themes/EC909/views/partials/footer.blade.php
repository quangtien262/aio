...
<footer class="ec99-footer"><div class="ec99-shell ec99-footer-grid">
    <section><a class="ec99-footer-logo" href="{{ route('site.home') }}" aria-label="{{ $siteName }}">@if($logo)<img src="{{ $logo }}" alt="{{ $siteName }}">@endif</a><p>Euro Sound là cửa hàng chuyên cung cấp các thiết bị âm thanh chính hãng như loa, tai nghe có dây, tai nghe không dây và headphone chất lượng cao.</p><nav><a href="#"><i class="fa-brands fa-facebook-f"></i></a><a href="#"><i class="fa-brands fa-x-twitter"></i></a><a href="#"><i class="fa-brands fa-youtube"></i></a><a href="#"><i class="fa-brands fa-instagram"></i></a></nav></section>
    <section><h3>Thông tin</h3><p><b>Địa chỉ:</b> {{ data_get($branding, 'support_location', '') }}</p><p><b>Điện thoại:</b> {{ data_get($branding, 'support_hotline', '') }}</p><p><b>Email:</b> {{ data_get($branding, 'support_email', '') }}</p><div class="ec99-marketplaces"><i>S</i><i>L</i><i>T</i><i>S</i></div></section>
