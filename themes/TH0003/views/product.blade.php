    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .fashion-product-page { background: #f7f5f2; }
            .fashion-product-page .utility { background: #fdfbf8; border-bottom-color: #eadfda; }
            .fashion-product-page .header { background: #fffaf6; border-bottom: 1px solid #eadfda; }
            .fashion-product-page .searchbar { border: 1px solid #1f1a1d; border-radius: 0; }
            .fashion-product-page .searchbar button, .fashion-product-page .nav { background: #1f1a1d; }
            .fashion-product-page .nav-category { background: #b20f3a; letter-spacing: .08em; }
            .fashion-product-page .nav-links a { letter-spacing: .08em; font-size: 12px; }
            .fashion-product-page .breadcrumb { color: #756a70; }
            .fashion-product-page .hero { grid-template-columns: minmax(0, .96fr) minmax(420px, .76fr); gap: 30px; align-items: start; margin-bottom: 28px; }
            .fashion-product-page .panel { border: 0; background: transparent; }
            .fashion-product-page .gallery-panel { padding: 0; }
            .fashion-product-page .gallery-stage { border: 0; background: #ded4cf; }
            .fashion-product-page .gallery-stage img { aspect-ratio: 4 / 5; }
            .fashion-product-page .gallery-thumbs { margin-top: 14px; }
            .fashion-product-page .gallery-thumb { border: 1px solid #d8cbc6; background: #fffaf6; border-radius: 0; }
            .fashion-product-page .gallery-thumb.is-active { border-color: #1f1a1d; box-shadow: inset 0 0 0 1px #1f1a1d; }
            .fashion-product-page .info-panel { background: #fffaf6; padding: clamp(26px, 4vw, 44px); box-shadow: 0 18px 44px rgba(31,26,29,.08); }
            .fashion-product-page .title { font-family: Georgia, 'Times New Roman', serif; font-weight: 500; font-size: clamp(34px, 5vw, 58px); line-height: 1; color: #1f1a1d; }
            .fashion-product-page .share { color: #b20f3a; letter-spacing: .14em; text-transform: uppercase; font-size: 11px; }
            .fashion-product-page .summary { color: #5f555a; }
            .fashion-product-page .price-box { border: 0; border-top: 1px solid #eadfda; border-bottom: 1px solid #eadfda; }
            .fashion-product-page .deal-price { color: #b20f3a; font-family: Georgia, 'Times New Roman', serif; font-weight: 500; }
            .fashion-product-page .discount-badge, .fashion-product-page .btn-primary { border-radius: 0; background: #1f1a1d; }
            .fashion-product-page .btn-secondary, .fashion-product-page .btn-favorite { border-radius: 0; border-color: #1f1a1d; color: #1f1a1d; background: transparent; }
            .fashion-product-page .moneyback { border-color: #f2c94c; background: #fff8d8; color: #7a5a00; }
            .fashion-fit-panel { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 8px; margin: 16px 0; }
            .fashion-fit-chip { min-height: 48px; display: grid; place-items: center; border: 1px solid #eadfda; background: #fff; color: #1f1a1d; font-size: 12px; font-weight: 900; letter-spacing: .1em; text-transform: uppercase; text-align: center; }
            .fashion-styling-note { margin-top: 14px; padding: 14px 16px; background: #1f1a1d; color: rgba(255,255,255,.78); line-height: 1.7; }
            .fashion-styling-note strong { display: block; color: #f2c94c; margin-bottom: 4px; letter-spacing: .12em; text-transform: uppercase; font-size: 12px; }
            .fashion-product-page .stats { border-top-color: #eadfda; color: #756a70; }
            .fashion-product-page .content-grid { grid-template-columns: minmax(0, 1fr) 340px; gap: 26px; }
            .fashion-product-page .section-panel, .fashion-product-page .sidebar-card { border: 0; background: #fffaf6; box-shadow: 0 14px 38px rgba(31,26,29,.07); }
            .fashion-product-page .section-title, .fashion-product-page .sidebar-card h3 { font-family: Georgia, 'Times New Roman', serif; font-size: 34px; text-transform: none; font-weight: 500; color: #1f1a1d; }
            .fashion-product-page .tab-button { letter-spacing: .08em; text-transform: uppercase; }
            .fashion-product-page .tab-button.is-active { border-top-color: #b20f3a; }
            .fashion-product-page .guide-hero { border: 0; background: #1f1a1d; color: #fff; }
            .fashion-product-page .guide-hero-copy h3 { color: #f2c94c; font-family: Georgia, 'Times New Roman', serif; font-weight: 500; }
            .fashion-product-page .guide-hero-copy p { color: rgba(255,255,255,.72); }
            .fashion-product-page .guide-badge { border-radius: 0; background: rgba(242,201,76,.16); color: #f2c94c; }
            .fashion-product-page .guide-step-badge { background: #b20f3a; }
            .fashion-product-page .sidebar-related-card img { height: 112px; object-fit: cover; }
            .fashion-product-page .th-footer { background: #1f1a1d; color: #fff; border: 0; }
            .fashion-product-page .th-footer-card h4, .fashion-product-page .th-company strong { color: #f2c94c; letter-spacing: .12em; }
            .fashion-product-page .th-footer-links { color: rgba(255,255,255,.68); }
            .fashion-product-page .th-company { background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.12); border-radius: 0; }
            @media (max-width: 1080px) {
                .fashion-product-page .hero, .fashion-product-page .content-grid { grid-template-columns: 1fr; }
            }
            @media (max-width: 720px) {
        ...
        <main class="wrap">
            ...
            <section class="hero">
                ...
                <div class="panel info-panel" id="deal-purchase">
                    ...
                    <div class="share">@themeT('product.share', 'Chia sẻ sản phẩm')</div>
                    <div class="summary">{{ $productModel->short_description ?: __('product.summary_fallback') }}</div>

                    <div class="fashion-fit-panel" aria-label="@themeT('product.fit_options', 'Gợi ý chọn size')">
                        <span class="fashion-fit-chip">@themeT('product.fit_size', 'Size ready')</span>
                        <span class="fashion-fit-chip">@themeT('product.fit_mix', 'Easy mix')</span>
                        <span class="fashion-fit-chip">@themeT('product.fit_season', 'Season edit')</span>
                    </div>
                    ...
                    <div class="fashion-styling-note">
                        <strong>@themeT('product.styling_note_title', 'Styling note')</strong>
                        <span>@themeT('product.styling_note_body', 'Gợi ý phối cùng phụ kiện tối giản, giày trung tính hoặc layer nhẹ để giữ tổng thể gọn và hợp nhiều bối cảnh.')</span>
                    </div>
                </div>
            </section>
                            ...
                            <div class="guide-intro">
                                <div class="guide-hero">
                                    <div class="guide-hero-copy">
                                        ...
                                        <p>{{ $t('product.guide_intro', 'Quy trình mua thời trang trên TH0003 được tối ưu theo hướng ít bước, dễ kiểm tra và thuận tiện khi mua online hoặc nhận hàng tại cửa hàng.') }}</p>
