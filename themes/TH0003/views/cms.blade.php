...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                                    ...
                                    <section class="th-cms-panel">
                                        ...
                                        <div class="th-cms-highlight-grid">
                                            <div class="th-cms-highlight">
                                                ...
                                                <span>{{ $t('cms.about.highlight_sync_body', 'Nội dung giới thiệu, tin tức và dữ liệu thương hiệu được render trực tiếp trên giao diện TH0003.') }}</span>
                                            </div>
                                            <div class="th-cms-highlight">
        ...
        @include('theme-th0003::partials.engagement-modals')
    </body>
</html>
