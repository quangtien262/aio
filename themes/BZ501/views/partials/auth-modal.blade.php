@unless (auth('customer')->check())
    <style>
        ...
        .xd-auth-tab.is-active { background: #ff3517; color: #fff; box-shadow: 0 12px 24px rgba(255, 53, 23, .24); }
        ...
        .xd-auth-submit { border: 0; border-radius: 8px; padding: 14px 18px; background: #ff3517; color: #fff; font-weight: 900; text-transform: uppercase; cursor: pointer; box-shadow: 0 12px 26px rgba(255, 53, 23, .22); }
    ...
    <script>
        (() => {
            if (window.__bz501AuthModalReady) return;
            window.__bz501AuthModalReady = true;
