...
return new class extends Migration
{
    public function up(): void
    {
        if (! Schema::hasTable('cms_projects')) {
            Schema::create('cms_projects', function (Blueprint $table): void {
                $table->id();
                $table->string('title');
        ...
        if (! Schema::hasTable('cms_project_images')) {
            Schema::create('cms_project_images', function (Blueprint $table): void {
                $table->id();
                $table->foreignId('cms_project_id')->constrained('cms_projects')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('cms_project_images');
