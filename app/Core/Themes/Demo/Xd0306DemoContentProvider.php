...
class Xd0306DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    public function preset(): array { return ['key' => self::PRESET_KEY, 'label' => 'Tư vấn doanh nghiệp', 'description' => 'Banner, dịch vụ, đối tác, menu và landingpage mẫu cho XD0306.']; }
    ...
    public function generate(string $presetKey): array
    {
        ...
        return DB::transaction(function (): array {
            ...
            foreach ([
                ...
                $banner = SiteBanner::query()->create(['theme_key' => self::THEME_KEY, 'placement' => 'xd0306-hero-slider', 'title' => $title, 'subtitle' => $summary, 'image_url' => $image($photo, 1920), 'link_url' => '#lien-he', 'badge' => 'Tư vấn doanh nghiệp', 'metadata' => ['kicker' => 'Tư vấn doanh nghiệp', 'summary' => $summary, 'button_label' => 'Nhận báo giá'], 'sort_order' => $index, 'is_active' => true]);
                $this->record($banner);
            }

            $menu = CmsMenu::query()->create(['name' => 'XD0306 Main Menu', 'location' => 'primary-navigation', 'items' => [['label' => 'Trang chủ', 'url' => '#top'], ['label' => 'Dịch vụ', 'url' => '#dich-vu'], ['label' => 'Giải pháp', 'url' => '#giai-phap'], ['label' => 'Thư viện', 'url' => '#thu-vien'], ['label' => 'Đối tác', 'url' => '#doi-tac'], ['label' => 'Liên hệ', 'url' => '#footer']]]);
            $this->record($menu);
