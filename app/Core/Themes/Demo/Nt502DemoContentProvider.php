...
class Nt502DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    public function generate(string $presetKey): array
    {
        ...
        return DB::transaction(function (): array {
            ...
            $profile=SiteProfile::query()->firstOrNew();$profile->forceFill(['site_name'=>'Dola Furniture','website_type'=>'ecommerce','active_theme_key'=>self::THEME_KEY,'branding'=>array_merge((array)$profile->branding,['company_name'=>'DOLA FURNITURE','company_description'=>'Nội thất Việt cho không gian sống hiện đại.','support_hotline'=>'1900 6750','support_email'=>'support@htvietnam.vn','support_location'=>'70 Lữ Gia, Phường 15, Quận 11, TP.HCM'])])->save();
