...
class Nt503DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    public function generate(string $presetKey): array
    {
        ...
        return DB::transaction(function (): array {
            ...
            $profile=SiteProfile::query()->firstOrNew();$profile->forceFill(['site_name'=>'WolfBed','website_type'=>'ecommerce','active_theme_key'=>self::THEME_KEY,'branding'=>array_merge((array)$profile->branding,['company_name'=>'WolfBed','company_description'=>'Nệm, chăn ga gối và phụ kiện chính hãng cho giấc ngủ sâu.','support_hotline'=>'0399162342','support_email'=>'support@htvietnam.vn','support_location'=>'70 Lữ Gia, Phường 15, Quận 11, Thành phố Hồ Chí Minh'])])->save();
