...
class Th0050DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    public function generate(string $presetKey): array
    {
        ...
        return DB::transaction(function (): array {
            ...
            $profile->forceFill(['site_name' => $profile->site_name ?: 'An Nhiên Nest', 'website_type' => 'ecommerce', 'active_theme_key' => self::THEME_KEY, 'branding' => array_merge((array) $profile->branding, ['company_name' => 'An Nhiên Nest', 'company_description' => 'Tinh hoa wellness và quà tặng sức khỏe cao cấp.', 'logo_url' => '', 'support_hotline' => '0399162342', 'support_email' => 'support@htrvietnam.vn', 'support_location' => 'TP. Hồ Chí Minh'])])->save();
