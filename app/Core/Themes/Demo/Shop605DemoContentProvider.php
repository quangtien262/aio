...
class Shop605DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    public function generate(string $presetKey): array
    {
        ...
        return DB::transaction(function (): array {
            ...
            $profile->forceFill(['site_name' => 'OH!Under', 'website_type' => 'ecommerce', 'active_theme_key' => self::THEME_KEY, 'branding' => array_merge((array) $profile->branding, ['company_name' => 'OH!Under', 'company_description' => 'Thiết kế nội y và đồ bơi tinh tế, thoải mái và tôn vinh đường cong.', 'support_hotline' => '1800.6750', 'support_email' => 'support@ohunder.vn', 'support_location' => '70 Lữ Gia, Phường 15, Quận 11, TP. Hồ Chí Minh'])])->save();
