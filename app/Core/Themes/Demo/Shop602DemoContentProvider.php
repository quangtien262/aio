...
class Shop602DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    public function generate(string $presetKey): array
    {
        ...
        return DB::transaction(function (): array {
            ...
            $page = CmsPage::query()->create(['title' => 'Liên hệ', 'slug' => 'contact', 'status' => 'published', 'excerpt' => 'Liên hệ Wolf Yoga.', 'body' => '<p>Đội ngũ Wolf Yoga luôn sẵn sàng đồng hành cùng bạn.</p>', 'publish_at' => now()]); $this->record($page);
            $profile = SiteProfile::query()->firstOrNew();
            $profile->forceFill(['site_name' => 'Wolf Yoga', 'website_type' => 'ecommerce', 'active_theme_key' => self::THEME_KEY, 'branding' => array_merge((array) $profile->branding, ['company_name' => 'WOLF YOGA', 'company_description' => 'Đồng hành cùng bạn trên hành trình sống khỏe, sống đẹp và hạnh phúc.', 'support_hotline' => '1900 6750', 'support_email' => 'support@sapo.vn', 'support_location' => '70 Lữ Gia, Phường 15, Quận 11, Thành phố Hồ Chí Minh'])])->save();
            ...
            return ['preset' => $this->preset(), 'counts' => ['categories' => 2, 'products' => 10, 'banners' => 2, 'post_categories' => 1, 'posts' => 4, 'pages' => 1, 'menus' => 1, 'landing_pages' => ! $existing && $landing ? 1 : 0], 'purged' => $purged];
        });
    }
