...
class Xd0312DemoContentProvider implements ThemeDemoContentProvider
{
    ...
    private const PRESET_KEY = 'xd0312-accounting-advisory';
    ...
    public function preset(): array
    {
        return [
            'key' => self::PRESET_KEY,
            'label' => 'Bizgrow accounting advisory',
            'description' => 'Default banner, accounting services, customer testimonials, news and fixed footer for XD0312.',
        ];
    }
        ...
        return DB::transaction(function (): array {
            ...
            foreach ([
                ...
                $banner = SiteBanner::query()->create([
                    ...
                    'link_url' => '#lien-he',
                    'badge' => 'Bizgrow advisory',
                    'metadata' => ['kicker' => 'Bizgrow advisory', 'summary' => $summary, 'button_label' => 'Tim hieu them'],
                    'sort_order' => $index,
                    'is_active' => true,
                ]);
                $this->record($banner);
